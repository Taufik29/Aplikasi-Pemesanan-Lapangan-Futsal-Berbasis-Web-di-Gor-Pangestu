...
<footer class="container footer-distributed">
	...
	<div class="footer-left">
		...
		<h3><img src="assets/images/logofutsal.png" width="100px" height="100px" />&nbsp;Futsal-<span>Gor Pangestu</span></h3>
		...
		<p class="footer-company-name">Pangestu team &copy; 2021 |</p>
	</div>
	...
	<div class="footer-right">
		...
		if (isset($_POST['kirim'])) { //ketika tombol kirim ditekan maka akan menjalankan code bagian ini
			...
			$email = "taufikulayya10@gmail.com"; //email penerima
			$to = $email;  //email penerima
			$subject = "Kritik Dan Saran dari $nama"; //subject pesan pada email

			//sender
			$sender = "taufikulayya10@gmail.com"; //email pengirim
