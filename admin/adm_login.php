...
<head>
  ...
  <title>Login Administration | Gor Pangestu</title>
  <link rel="shortcut icon" href="../assets/images/logofutsal.png">
  <!-- Bootstrap -->
        ...
        <section class="login_content">
          <form action="" method="post">
            ...
            <div class="separator">
              ...
              <div>
                <h1><img src="../assets/images/logofutsal.png" style="width:25px; height:25px;"> Gor<font color="#6fcb44"> Pangestu</font>
                </h1>
                <p>Gor Pangestu Team</p>
