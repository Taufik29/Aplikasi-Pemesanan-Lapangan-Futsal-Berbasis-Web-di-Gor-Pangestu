			...
			?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                              <div class="radio">
                                  <label><input type="radio" name="rek_tuju" value="bca"><img src="assets/images/bca.png" style="width:80px; height:30px;"> 8888-225-650-88 (an. Taufik Ulayya Riyanto)</label>
                                </div>
                                <br>
                                <div class="radio">
                                  <label><input type="radio" name="rek_tuju" value="bri"><img src="assets/images/bri.gif" style="width:80px; height:30px;"> 2586-3544-4587-12 (an. Taufik Ulayya Riyanto)</label>
                                </div>
                                <br>
                                <div class="radio">
                                  <label><input type="radio" name="rek_tuju" value="mandiri"><img src="assets/images/mandiri.png" style="width:80px; height:30px;"> 1240-555-697-12 (an. Taufik Ulayya Riyanto)</label>
                                </div>
                            </div>
                          </div>
                          <br>
